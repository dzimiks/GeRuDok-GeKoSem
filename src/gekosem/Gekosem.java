...
public class Gekosem extends JDialog implements AdjustmentListener, Serializable, ClipboardOwner {
	...
	private static GekosemClipboard gekosemClipboard;
	...
	private Clipboard clipboard=new Clipboard("GeKoSeM clipboard"); 
	...
	public Gekosem(Slot slot) {
		...
		gekosemClipboard = new GekosemClipboard();
	...
	public GekosemClipboard getGekosemClipboard() {
		return gekosemClipboard;
	}

	public void setGekosemClipboard(GekosemClipboard gekosemClipboard) {
		this.gekosemClipboard = gekosemClipboard;
	}
