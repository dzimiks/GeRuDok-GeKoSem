...
import gui.commands.RenameElementCommand;
...
public class PaletteView extends JToolBar {
	...
	public PaletteView(Slot slot, Gekosem g) {
		...
		cut = new JToggleButton(new PCutAction(g, slot));
		cut.setToolTipText("Cut");
		cut.setIcon(new ImageIcon("images/palette-icons/cut.png"));
		
		copy = new JToggleButton(new PCopyAction(g, slot));
		copy.setToolTipText("Copy");
		copy.setIcon(new ImageIcon("images/palette-icons/copy.png"));
		
		paste = new JToggleButton(new PPasteAction(g, slot));
		...
		delete.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				Invoker.getInstance().executeCommand(new DeleteElementCommand((slot.getSelectionModels().getSelectionList())));
			}
		});
		...
		rename = new JButton();
		rename.setToolTipText("Rename element");
		rename.setIcon(new ImageIcon("images/palette-icons/rename.png"));
		rename.addActionListener(new ActionListener() {
			
			@Override
			public void actionPerformed(ActionEvent e) {
				Invoker.getInstance().executeCommand(new RenameElementCommand(model, slot));;
			}
		});
